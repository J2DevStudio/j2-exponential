      ...
      <div className="container">
        <SectionBorder>
          <SectionContent className="!pt-0">
            ...
            <div className="flex mt-20 overflow-x-clip -mx-4 lg:-mx-8 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]">
              <div className="flex flex-none gap-18 md:gap-24 lg:gap-36 px-18">
