        ...
        <SectionBorder borderTop>
          <SectionContent className="md:px-20 lg:px-40">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div id="featuresText" className="flex flex-col items-center">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-300 leading-tight text-center">
              ...
              <div id="featuresGraph" className="flex justify-center">
                <div className="size-[270px] md:size-[450px] relative flex flex-shrink-0">
                  ...
                  {logos.map(({ src, alt, rotate }) => (
                    ...
                    >
                      <div
                        className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-45 inline-flex size-10 md:size-14 items-center justify-center border border-[var(--color-border)] rounded-lg bg-gray-950"
                        style={{
